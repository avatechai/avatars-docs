...
A simple example of how to use display a generated avatar using the SDK.

```jsx useAvatar hook
import { useAvatar } from '@avatechai/avatars/react';
import { defaultAvatarLoaders, defaultBlendshapesService } from '@avatechai/avatars/default-loaders';
